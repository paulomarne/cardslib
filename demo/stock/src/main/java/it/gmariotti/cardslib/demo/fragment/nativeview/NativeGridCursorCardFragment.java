...
public class NativeGridCursorCardFragment extends BaseNativeListFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected String getSourceUrl() {
        return "https://github.com/paulomarne/cardlibs/blob/master/demo/stock/src/main/java/it/gmariotti/cardslib/demo/fragment/nativeview/NativeGridCursorCardFragment.java";
    }
