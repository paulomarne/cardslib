...
public class NativeListSectionedCardFragment extends MaterialV1Fragment {
    ...
    protected String getDocUrl() {
        return "https://github.com/paulomarne/cardlibs/blob/master/doc/EXPAND.md";
    }

    @Override
    protected String getSourceUrl() {
        return "https://github.com/paulomarne/cardlibs/blob/master/demo/stock/src/main/java/it/gmariotti/cardslib/demo/fragment/nativeview/NativeListSectionedCardFragment.java";
    }
